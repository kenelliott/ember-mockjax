...
test "index [sideloading]", ->
  visit("/players").then ->
    ...
    equal find(".player:nth(0) .weapons > li:nth(0) li").length, 1, "One attachment is rendered."
    equal find(".player:nth(0) .weapons > li:nth(1) li").length, 1, "One attachment is rendered."
